...
?>
                                ...
                                <td nowrap>
                                    ...
                                    <i class="btn btn-sm btn-outlinesecondary"><i class="fas fa-fw fa-edit"></i>Ubah
                                        Status</i>
                                    <?php } else { ?>
                                    <a class="btn btn-sm btn-outlineinfo"
                                        href="<?= base_url('pinjam/ubahStatus/' . $p['id_buku'] . '/' . $p['no_pinjam']); ?>">
                                        <iclass="fas fa-fw fa-edit">
                                            </iclass=>Ubah Status
                                    </a>
                                    <?php } ?>
                                </td>
